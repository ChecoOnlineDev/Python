...
Situación Detallada:
Estás desarrollando el sistema de registro de una aplicación bancaria. La seguridad es crítica.
Has investigado que las contraseñas débiles son la causa del 80% de los hackeos. 
Necesitas un filtro automático que rechace contraseñas inseguras 
ANTES de que se guarden en la base de datos.
